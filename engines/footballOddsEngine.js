...
function mapCompetitionToSportKey(code) {
  ...
  /* ---------- ENGLAND ---------- */
  if (c === "EFL") return "soccer_efl_championship";

  /* ---------- GERMANY ---------- */
  if (c === "BL2") return "soccer_germany_bundesliga_2";
  ...
  /* ---------- SAUDI ---------- */
  if (c === "SPL") return "soccer_saudi_pro_league";

  /* ---------- JAPAN ---------- */
  if (c === "J1") return "soccer_japan_j_league";
