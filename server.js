...
/* --------------------------------------------------
   ACCUMULATOR TEST ROUTE (GET FOR MOBILE)
-------------------------------------------------- */
app.get("/api/accumulator-test", (req, res) => {

  const selections = [
    { adjustedProbability: "62.1" },
    { adjustedProbability: "55.3" },
    { adjustedProbability: "68.6" }
  ];
