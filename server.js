...
/* ===========================
   SECURITY MIDDLEWARE — FIXED CSP FOR INLINE SCRIPTS, EVENT HANDLERS, GOOGLE FONTS & TAWK.TO
=========================== */
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-hashes'", "https://js.paystack.co", "https://propredict-app.onrender.com", "https://embed.tawk.to", "https://tawk.to"],
      scriptSrcAttr: ["'self'", "'unsafe-inline'", "'unsafe-hashes'"],
      styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com"],
      fontSrc: ["'self'", "https://fonts.gstatic.com"],
      imgSrc: ["'self'", "data:", "https:"],
      connectSrc: ["'self'", "https://api.paystack.co", "https://propredict-app.onrender.com", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://embed.tawk.to", "https://tawk.to", "wss://embed.tawk.to"],
      frameSrc: ["'self'", "https://checkout.paystack.com", "https://embed.tawk.to", "https://tawk.to"],
    },
  },
}));
...
console.log("✅ CSP Updated: Inline scripts, event handlers, Google Fonts & Tawk.to allowed");
