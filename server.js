...
/* --------------------------------------------------
   MULTI-SPORT TOP PICKS (ARCHITECTURE LAYER)
-------------------------------------------------- */
app.get("/api/top-picks/:sport/:competition", async (req, res) => {
  ...
  if (sport.toLowerCase() === "football") {
    return res.redirect(`/api/top-picks/${competition}`);
  }
  ...
  if (sport.toLowerCase() === "basketball") {
    return res.json({
      sport,
      competition,
      status: "Basketball engine not connected yet",
      topPicks: []
    });
  }
  ...
  if (sport.toLowerCase() === "darts") {
    return res.json({
      sport,
      competition,
      status: "Darts engine not connected yet",
      topPicks: []
    });
  }
  ...
  if (sport.toLowerCase() === "tabletennis") {
    return res.json({
      sport,
      competition,
      status: "Table Tennis engine not connected yet",
      topPicks: []
    });
  }
