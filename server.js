...
/* ===========================
   SECURITY MIDDLEWARE — FIXED CSP FOR INLINE SCRIPTS, EVENT HANDLERS, GOOGLE FONTS & TAWK.TO (FULL)
=========================== */
app.use(helmet({
...
console.log("✅ CSP Updated: Full Tawk.to support including va.tawk.to");
