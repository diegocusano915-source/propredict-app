...
// Helper to generate placeholder teams when API unavailable
...
app.get("/api/basketball/teams/:competition", async (req, res) => {
  try {
    ...
    // Try API-Football basketball endpoint if key exists
...
console.log("✅ Multi-Sport Teams: Basketball, NFL, NHL, MLB, Tennis, Rugby, Darts, Table Tennis");
