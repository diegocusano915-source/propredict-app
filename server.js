...
console.log("✅ All personal identifiers removed - Author: The ProPredict Analytics Team");
console.log("✅ Register route: Email failure is now non-fatal (won't block registration)");
