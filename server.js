...
/* ===========================
   SECURITY MIDDLEWARE — FIXED CSP FOR INLINE SCRIPTS
=========================== */
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "https://js.paystack.co", "https://propredict-app.onrender.com"],
      styleSrc: ["'self'", "'unsafe-inline'"],
      imgSrc: ["'self'", "data:", "https:"],
      connectSrc: ["'self'", "https://api.paystack.co", "https://propredict-app.onrender.com"],
...
console.log("✅ CSP Updated: Inline scripts allowed");
