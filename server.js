...
/* ===========================
   SECURITY MIDDLEWARE — FIXED CSP FOR INLINE SCRIPTS, EVENT HANDLERS, GOOGLE FONTS & TAWK.TO (FULL + CSS)
=========================== */
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.paystack.co", "https://propredict-app.onrender.com", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://embed.tawk.to", "https://tawk.to", "https://va.tawk.to", "wss://embed.tawk.to", "wss://va.tawk.to"],
...
console.log("✅ CSP Updated: Full Tawk.to support including CSS stylesheets");
