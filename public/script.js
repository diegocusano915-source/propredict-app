...
function updateCompetitionOptions() {
    ...
    if (currentSport === "football") {
        ...
        addOption("FL1", "Ligue 1"); // ✅ RESTORED
    }

    if (currentSport === "basketball") {
        addOption("NBA", "NBA");
        addOption("WNBA", "WNBA");   // ✅ ADDED
        addOption("NCAAB", "NCAAB"); // ✅ ADDED
    }
...
// ==========================================================
// RENDER TOP PICKS + ACCUMULATOR + TEAM ANALYSIS
// (UNCHANGED STABLE CODE BELOW)
// ==========================================================
