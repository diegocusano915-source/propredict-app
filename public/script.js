...
// ==========================================================
// ✅ SMART BUILDER UI INJECTION (UX IMPROVED)
// ==========================================================
...
function injectSmartBuilderUI() {
    ...
    wrapper.innerHTML = `
        ...
        <div id="smartTierLabel" style="font-size:12px; color:#94a3b8;"></div>
    `;
...
// ==========================================================
// ✅ SMART BUILDER LOGIC (UX POLISHED)
// ==========================================================
...
async function buildSmartAccumulator() {
    ...
    try {
        ...
        const button = document.getElementById("buildSmartBtn");
        const tierLabel = document.getElementById("smartTierLabel");

        button.disabled = true;
        button.textContent = "Building...";
        tierLabel.textContent = `Generating ${smartTier.toUpperCase()} accumulator...`;
        ...
        if (!data || !Array.isArray(data.selections) || !data.selections.length) {
            tierLabel.textContent = "No valid combination found.";
            smartBuilderLoading = false;
            button.disabled = false;
            button.textContent = "Build Smart Bet";
            return;
        }
        ...
        tierLabel.textContent = `Tier: ${data.tier.toUpperCase()} | Odds: ${data.decimalOdds}`;

        // ✅ Auto scroll to accumulator
        document.querySelector(".accumulator-section").scrollIntoView({
            behavior: "smooth"
        });

        // ✅ Temporary highlight
        DOM.accumulatorContainer.classList.add("highlight-smart");
        setTimeout(() => {
            DOM.accumulatorContainer.classList.remove("highlight-smart");
        }, 1500);
        ...
        smartBuilderLoading = false;
        document.getElementById("buildSmartBtn").disabled = false;
        document.getElementById("buildSmartBtn").textContent = "Build Smart Bet";
    }
}
// ==========================================================
// EVENT BINDING
