...
// =====================================================
// ✅ RESTORED ORIGINAL COMPETITION LOADER
...
async function loadCompetitions(sport) {
    ...
    try {
        // This route was working before. We DO NOT alter it.
        ...
        if (Array.isArray(data)) {
            data.forEach(item => {
                ...
                option.value = item.code || item.id || item.leagueCode;
...
// =====================================================
// LOAD TOP PICKS (UNCHANGED CONTRACT)
// =====================================================
...
function addToAccumulator(pick) {
    ...
    // ✅ Performance auto-record (safe addition only)
    recordPick(pick);
}
...
// =====================================================
// PERFORMANCE TRACKING (ADDED WITHOUT TOUCHING CORE)
// =====================================================
...
async function loadPerformanceSummary() {
    try {
        ...
        if (document.getElementById("totalPicks")) {
