...
const DOM = {
    ...
    // ✅ Smart Builder DOM (Injected Later)
...
// ==========================================================
// COMPETITION OPTIONS PER SPORT (EXPANDED)
// ==========================================================
...
function normalizePicks(raw) {
    ...
    // ✅ Array format (legacy or simplified sports)
    ...
    // ✅ Object grouped by market (football + basketball)
...
function generateSmartAccumulator() {
    ...
    // ✅ Flatten picks into uniform structure
    ...
    // ✅ Fallback if not enough in strict band
...
// ==========================================================
// TIER CONFIGURATION (MIDPOINT OPTIMIZED)
// ==========================================================
