...
function renderTopPicks() {
    ...
    // ✅ NEW: Basketball accordion rendering
    if (currentSport === "basketball") {
        ...
        topPicksData.forEach(pick => {
            ...
            matches[pick.matchId].push(pick);
        });

        Object.keys(matches).forEach(matchId => {

            const matchPicks = matches[matchId];
            ...
            header.innerHTML = `
                <strong>${firstPick.homeTeam} vs ${firstPick.awayTeam}</strong>
