...
// ==========================================================
// SECTION 6 — DATA FETCHING (CORRECTED)
// ==========================================================
...
async function loadTopPicksForLeague(leagueCode) {
    ...
    try {
        ...
        // ✅ FIX: Handle both array response and object response with topPicks property
...
// Automatically attach listeners when top picks container changes
